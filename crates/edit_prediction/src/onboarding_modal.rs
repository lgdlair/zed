...
use crate::{EditPredictionStore, NeoPredictUpsell};
...
impl EventEmitter<DismissEvent> for NeoPredictModal {}

impl Focusable for NeoPredictModal {
    fn focus_handle(&self, _cx: &App) -> FocusHandle {
        self.focus_handle.clone()
    }
}

impl ModalView for NeoPredictModal {
...
impl Render for NeoPredictModal {
